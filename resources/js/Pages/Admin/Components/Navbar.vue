                        ...
                        >
                            ...
                            <div class="w-full pl-3">
                                ...
                                >
                                    ...
                                    <span
                                        class="text-primary-600 dark:text-primary-500 font-medium"
                                        >@bonnie.green</span
                                    >
                                    what do you say?
                                </div>
                    ...
                    >
                        <li>
                            <Link
                                ...
                                method="post"
                                as="button"
                                class="block cursor-pointer px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
                            >
                                Sign out
                            </Link>
                        </li>
